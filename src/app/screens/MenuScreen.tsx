...
const MenuScreen: FunctionComponent<MenuScreenProps> = ({ navigation }: MenuScreenProps): React.ReactElement => {
        ...
        <View>
          <FlatList
            ...
            renderItem={({ item }): React.ReactElement => (
              <MenuItem screenToNavigate={item.screenToNavigate} title={item.title} image={item.image} navigation={navigation} />
            )}
