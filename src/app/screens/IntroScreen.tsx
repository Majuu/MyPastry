...
const IntroScreen: FunctionComponent<IntroScreenProps> = ({ navigation }: IntroScreenProps): React.ReactElement => {
    ...
    <FullScreenContainer>
      <View style={styles.container}>
        ...
        <CustomText
          ...
          color={ColorsEnum.DARK_GREEN}
        />
        <Cake width={imageDimensions} height={imageDimensions} style={styles.cakeImage} />
        <CustomButton
          style={styles.button}
